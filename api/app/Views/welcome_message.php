...
<head>
    <meta charset="UTF-8">
    <title>API REST creada con CodeIgniter 4!</title>
...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Bienvenidos a Desarrollo de Aplicaciones Web con CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

        <h2>Actividad Practica#3</h2>
...
<section>
    ...
    <p>Ruth Cristina Rocafuerte Gavilánez.</p>

    <p>Sexto Semestre TI</p>
